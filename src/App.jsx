    ...
    <div>
        ...
        <div className="container">
          <div className="header-content">
            ...
            <div className="author-links">
              <a 
                href="https://github.com/GeekyWizKid/uml-generate" 
                target="_blank" 
                rel="noopener noreferrer"
                className="author-link github-link"
                title="GitHub: UML Generate Project"
              >
      ...
      <div className="container">
        <div className="main-content">
            ...
            {result && !isGenerating && (
              <div className="card result-card">
                <div className="result-header">
                  <h2 className="card-title">分析文档</h2>
            ...
            {!result && !isGenerating && !error && (
              <div className="card">
                <div className="empty-state">
                  ...
                  <h3 className="empty-title">等待生成分析文档</h3>
                  <p className="empty-description">AI将在这里生成详细的需求分析文档</p>
                </div>
              </div>
            )}
          </div>
          ...
          {/* UML图表区域 */}
          <div className="uml-result-section">
            {/* UML图表加载状态 */}
            {isGenerating && (
              <div className="card">
                {useStreaming ? (
            ...
            {result && !isGenerating && (
              <div className="card result-card">
                <div className="result-header">
                  <h2 className="card-title">UML图表</h2>
                  <div className="result-meta">
                    <span>PlantUML渲染</span>
                  </div>
                </div>
                <PlantUMLRenderer 
            ...
            {!result && !isGenerating && !error && (
              <div className="card">
                <div className="empty-state">
                  <div className="empty-icon">📊</div>
                  <h3 className="empty-title">等待生成UML图表</h3>
                  <p className="empty-description">UML图表将在这里显示</p>
                </div>
              </div>
            )}
          </div>
